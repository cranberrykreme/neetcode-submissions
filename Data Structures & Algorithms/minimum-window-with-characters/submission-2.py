    ...
    def minWindow(self, s: str, t: str) -> str:
        ...
        for i in range(len(s)):
            ...
            while curr_hits == len(t):
                if short_left-short_right == 0 or short_right-short_left > i-left_wall:
                    short_left, short_right = left_wall, i+1
        ...
        return "" if short_left - short_right == 0 else s[short_left:short_right]